...
import com.imovie.domain.Picture;
import com.imovie.exception.BadRequestException;
import com.imovie.repository.PictureRepository;
import com.imovie.service.PictureService;
import com.imovie.service.dto.PictureQueryCriteria;
...
public class PictureServiceImpl implements PictureService {
    ...
    public Picture upload(MultipartFile multipartFile, String username) {
        ...
        try {
            ...
            throw new IORuntimeException("上传失败，连接超时");
        } catch (Exception e) {
            log.error(e.getMessage());
            throw new BadRequestException("上传失败，请稍后再试");
        }
    }
