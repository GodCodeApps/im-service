...
-- ----------------------------
-- Table structure for t_column_config
-- ----------------------------
...
-- ----------------------------
-- Records of t_column_config
-- ----------------------------
INSERT INTO `t_column_config`
VALUES (1, 'gen_test', 'id', 'int', NULL, 'auto_increment', b'0', NULL, 'PRI', b'0', b'1', NULL, 'ID', NULL);
INSERT INTO `t_column_config`
VALUES (2, 'gen_test', 'sex', 'int', NULL, '', b'1', NULL, '', b'1', b'0', 'NotNull', '性别', NULL);
INSERT INTO `t_column_config`
VALUES (3, 'gen_test', 'create_time', 'datetime', NULL, '', b'0', NULL, '', b'1', b'0', 'BetWeen', '', NULL);
...
-- ----------------------------
INSERT INTO `t_dept`
VALUES (1, 'EL-ADMIN', 0, b'1', '2019-03-01 12:07:37');
INSERT INTO `t_dept`
VALUES (2, '研发部', 7, b'1', '2019-03-25 09:15:32');
INSERT INTO `t_dept`
VALUES (5, '运维部', 7, b'1', '2019-03-25 09:20:44');
INSERT INTO `t_dept`
VALUES (6, '测试部', 8, b'1', '2019-03-25 09:52:18');
INSERT INTO `t_dept`
VALUES (7, '华南分部', 1, b'1', '2019-03-25 11:04:50');
INSERT INTO `t_dept`
VALUES (8, '华北分部', 1, b'1', '2019-03-25 11:04:53');
INSERT INTO `t_dept`
VALUES (11, '人事部', 8, b'1', '2019-03-25 11:07:58');
...
-- ----------------------------
INSERT INTO `t_dict`
VALUES (1, 'user_status', '用户状态', '2019-10-27 20:31:36');
INSERT INTO `t_dict`
VALUES (4, 'dept_status', '部门状态', '2019-10-27 20:31:36');
INSERT INTO `t_dict`
VALUES (5, 'job_status', '岗位状态', '2019-10-27 20:31:36');
...
(
    ...
    CONSTRAINT `FK5tpkputc6d9nboxojdbgnpmyb` FOREIGN KEY (`dict_id`) REFERENCES t_dict (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  AUTO_INCREMENT = 7
  CHARACTER SET = utf8
...
VALUES (1, '激活', 'true', '1', 1, '2019-10-27 20:31:36');
INSERT INTO `t_dict_detail`
VALUES (2, '禁用', 'false', '2', 1, NULL);
INSERT INTO `t_dict_detail`
VALUES (3, '启用', 'true', '1', 4, NULL);
INSERT INTO `t_dict_detail`
VALUES (4, '停用', 'false', '2', 4, '2019-10-27 20:31:36');
...
-- ----------------------------
-- Table structure for t_gen_config
-- ----------------------------
DROP TABLE IF EXISTS `t_gen_config`;
...
-- ----------------------------
-- Records of t_gen_config
-- ----------------------------
INSERT INTO `t_gen_config`
VALUES (3, 'gen_test', 'Zheng Jie', b'1', 'admin-system', 'com.imovie.gen',
        'E:\\workspace\\me\\front\\admin-web\\src\\views\\gen', 'E:\\workspace\\me\\front\\admin-web\\src\\api',
        NULL, '测试生成');
-- ----------------------------
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '代码生成测试'
  ROW_FORMAT = Compact;
...
(
    ...
    CONSTRAINT `FKmvhj0rogastlctflsxf1d6k3i` FOREIGN KEY (`dept_id`) REFERENCES t_dept (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  AUTO_INCREMENT = 13
  CHARACTER SET = utf8
...
-- ----------------------------
INSERT INTO `t_job`
VALUES (8, '人事专员', b'1', 3, 11, '2019-03-29 14:52:28');
INSERT INTO `t_job`
VALUES (10, '产品经理', b'1', 4, 2, '2019-03-29 14:55:51');
INSERT INTO `t_job`
VALUES (11, '全栈开发', b'1', 2, 2, '2019-03-31 13:39:30');
INSERT INTO `t_job`
VALUES (12, '软件测试', b'1', 5, 2, '2019-03-31 13:39:43');

-- ----------------------------
-- Table structure for t_local_storage
-- ----------------------------
DROP TABLE IF EXISTS `t_local_storage`;
CREATE TABLE `t_local_storage`
(
    `id`          bigint(20)                                              NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
INSERT INTO `t_menu`
VALUES (1, b'0', '系统管理', NULL, 0, 1, 'system', 'system', b'0', b'0', NULL, '2018-12-18 15:11:29', NULL, 0);
INSERT INTO `t_menu`
VALUES (2, b'0', '用户管理', 'system/user/index', 1, 2, 'peoples', 'user', b'0', b'0', 'User', '2018-12-18 15:14:44',
        'user:list', 1);
INSERT INTO `t_menu`
VALUES (3, b'0', '角色管理', 'system/role/index', 1, 3, 'role', 'role', b'0', b'0', 'Role', '2018-12-18 15:16:07',
        'roles:list', 1);
INSERT INTO `t_menu`
VALUES (5, b'0', '菜单管理', 'system/menu/index', 1, 5, 'menu', 'menu', b'0', b'0', 'Menu', '2018-12-18 15:17:28',
        'menu:list', 1);
INSERT INTO `t_menu`
VALUES (6, b'0', '系统监控', NULL, 0, 10, 'monitor', 'monitor', b'0', b'0', NULL, '2018-12-18 15:17:48', NULL, 0);
INSERT INTO `t_menu`
VALUES (7, b'0', '操作日志', 'monitor/log/index', 6, 11, 'log', 'logs', b'0', b'0', 'Log', '2018-12-18 15:18:26', NULL, 1);
INSERT INTO `t_menu`
VALUES (9, b'0', 'SQL监控', 'monitor/sql/index', 6, 18, 'sqlMonitor', 'druid', b'0', b'0', 'Sql', '2018-12-18 15:19:34',
        NULL, 1);
INSERT INTO `t_menu`
VALUES (10, b'0', '组件管理', NULL, 0, 50, 'zujian', 'components', b'0', b'0', NULL, '2018-12-19 13:38:16', NULL, 0);
INSERT INTO `t_menu`
VALUES (11, b'0', '图标库', 'components/icons/index', 10, 51, 'icon', 'icon', b'0', b'0', 'Icons', '2018-12-19 13:38:49',
        NULL, 1);
INSERT INTO `t_menu`
VALUES (14, b'0', '邮件工具', 'tools/email/index', 36, 35, 'email', 'email', b'0', b'0', 'Email', '2018-12-27 10:13:09',
        NULL, 1);
INSERT INTO `t_menu`
VALUES (15, b'0', '富文本', 'components/Editor', 10, 52, 'fwb', 'tinymce', b'0', b'0', 'Editor', '2018-12-27 11:58:25',
        NULL, 1);
INSERT INTO `t_menu`
VALUES (16, b'0', '图床管理', 'tools/picture/index', 36, 33, 'image', 'pictures', b'0', b'0', 'Pictures',
        '2018-12-28 09:36:53', 'pictures:list', 1);
INSERT INTO `t_menu`
VALUES (18, b'0', '存储管理', 'tools/storage/index', 36, 34, 'qiniu', 'storage', b'0', b'0', 'Storage',
        '2018-12-31 11:12:15', 'storage:list', 1);
INSERT INTO `t_menu`
VALUES (19, b'0', '支付宝工具', 'tools/aliPay/index', 36, 37, 'alipay', 'aliPay', b'0', b'0', 'AliPay',
        '2018-12-31 14:52:38', NULL, 1);
INSERT INTO `t_menu`
VALUES (21, b'0', '多级菜单', '', 0, 900, 'menu', 'nested', b'0', b'1', NULL, '2019-01-04 16:22:03', NULL, 0);
INSERT INTO `t_menu`
VALUES (22, b'0', '二级菜单1', 'nested/menu1/index', 21, 999, 'menu', 'menu1', b'0', b'0', NULL, '2019-01-04 16:23:29',
        NULL, 1);
INSERT INTO `t_menu`
VALUES (23, b'0', '二级菜单2', 'nested/menu2/index', 21, 999, 'menu', 'menu2', b'0', b'0', NULL, '2019-01-04 16:23:57',
        NULL, 1);
INSERT INTO `t_menu`
VALUES (24, b'0', '三级菜单1', 'nested/menu1/menu1-1', 22, 999, 'menu', 'menu1-1', b'0', b'0', NULL, '2019-01-04 16:24:48',
        NULL, 1);
INSERT INTO `t_menu`
VALUES (27, b'0', '三级菜单2', 'nested/menu1/menu1-2', 22, 999, 'menu', 'menu1-2', b'0', b'0', NULL, '2019-01-07 17:27:32',
        NULL, 1);
INSERT INTO `t_menu`
VALUES (28, b'0', '定时任务', 'system/timing/index', 36, 31, 'timing', 'timing', b'0', b'0', 'Timing',
        '2019-01-07 20:34:40', 'timing:list', 1);
INSERT INTO `t_menu`
VALUES (30, b'0', '代码生成', 'generator/index', 36, 32, 'dev', 'generator', b'1', b'0', 'GeneratorIndex',
        '2019-01-11 15:45:55', NULL, 1);
INSERT INTO `t_menu`
VALUES (32, b'0', '异常日志', 'monitor/log/errorLog', 6, 12, 'error', 'errorLog', b'0', b'0', 'ErrorLog',
        '2019-01-13 13:49:03', NULL, 1);
INSERT INTO `t_menu`
VALUES (33, b'0', 'Markdown', 'components/MarkDown', 10, 53, 'markdown', 'markdown', b'0', b'0', 'Markdown',
        '2019-03-08 13:46:44', NULL, 1);
INSERT INTO `t_menu`
VALUES (34, b'0', 'Yaml编辑器', 'components/YamlEdit', 10, 54, 'dev', 'yaml', b'0', b'0', 'YamlEdit',
        '2019-03-08 15:49:40', NULL, 1);
INSERT INTO `t_menu`
VALUES (35, b'0', '部门管理', 'system/dept/index', 1, 6, 'dept', 'dept', b'0', b'0', 'Dept', '2019-03-25 09:46:00',
        'dept:list', 1);
INSERT INTO `t_menu`
VALUES (36, b'0', '系统工具', '', 0, 30, 'sys-tools', 'sys-tools', b'0', b'0', NULL, '2019-03-29 10:57:35', NULL, 0);
INSERT INTO `t_menu`
VALUES (37, b'0', '岗位管理', 'system/job/index', 1, 7, 'Steve-Jobs', 'job', b'0', b'0', 'Job', '2019-03-29 13:51:18',
        'job:list', 1);
INSERT INTO `t_menu`
VALUES (38, b'0', '接口文档', 'tools/swagger/index', 36, 36, 'swagger', 'swagger2', b'0', b'0', 'Swagger',
        '2019-03-29 19:57:53', NULL, 1);
INSERT INTO `t_menu`
VALUES (39, b'0', '字典管理', 'system/dict/index', 1, 8, 'dictionary', 'dict', b'0', b'0', 'Dict', '2019-04-10 11:49:04',
        'dict:list', 1);
INSERT INTO `t_menu`
VALUES (41, b'0', '在线用户', 'monitor/online/index', 6, 10, 'Steve-Jobs', 'online', b'0', b'0', 'OnlineUser',
        '2019-10-26 22:08:43', NULL, 1);
INSERT INTO `t_menu`
VALUES (44, b'0', '用户新增', '', 2, 2, '', '', b'0', b'0', '', '2019-10-29 10:59:46', 'user:add', 2);
INSERT INTO `t_menu`
VALUES (45, b'0', '用户编辑', '', 2, 3, '', '', b'0', b'0', '', '2019-10-29 11:00:08', 'user:edit', 2);
INSERT INTO `t_menu`
VALUES (46, b'0', '用户删除', '', 2, 4, '', '', b'0', b'0', '', '2019-10-29 11:00:23', 'user:del', 2);
INSERT INTO `t_menu`
VALUES (48, b'0', '角色创建', '', 3, 2, '', '', b'0', b'0', '', '2019-10-29 12:45:34', 'roles:add', 2);
INSERT INTO `t_menu`
VALUES (49, b'0', '角色修改', '', 3, 3, '', '', b'0', b'0', '', '2019-10-29 12:46:16', 'roles:edit', 2);
INSERT INTO `t_menu`
VALUES (50, b'0', '角色删除', '', 3, 4, '', '', b'0', b'0', '', '2019-10-29 12:46:51', 'roles:del', 2);
INSERT INTO `t_menu`
VALUES (52, b'0', '菜单新增', '', 5, 2, '', '', b'0', b'0', '', '2019-10-29 12:55:07', 'menu:add', 2);
INSERT INTO `t_menu`
VALUES (53, b'0', '菜单编辑', '', 5, 3, '', '', b'0', b'0', '', '2019-10-29 12:55:40', 'menu:edit', 2);
INSERT INTO `t_menu`
VALUES (54, b'0', '菜单删除', '', 5, 4, '', '', b'0', b'0', '', '2019-10-29 12:56:00', 'menu:del', 2);
INSERT INTO `t_menu`
VALUES (56, b'0', '部门新增', '', 35, 2, '', '', b'0', b'0', '', '2019-10-29 12:57:09', 'dept:add', 2);
INSERT INTO `t_menu`
VALUES (57, b'0', '部门编辑', '', 35, 3, '', '', b'0', b'0', '', '2019-10-29 12:57:27', 'dept:edit', 2);
INSERT INTO `t_menu`
VALUES (58, b'0', '部门删除', '', 35, 4, '', '', b'0', b'0', '', '2019-10-29 12:57:41', 'dept:del', 2);
INSERT INTO `t_menu`
VALUES (60, b'0', '岗位新增', '', 37, 2, '', '', b'0', b'0', '', '2019-10-29 12:58:27', 'job:add', 2);
INSERT INTO `t_menu`
VALUES (61, b'0', '岗位编辑', '', 37, 3, '', '', b'0', b'0', '', '2019-10-29 12:58:45', 'job:edit', 2);
INSERT INTO `t_menu`
VALUES (62, b'0', '岗位删除', '', 37, 4, '', '', b'0', b'0', '', '2019-10-29 12:59:04', 'job:del', 2);
INSERT INTO `t_menu`
VALUES (64, b'0', '字典新增', '', 39, 2, '', '', b'0', b'0', '', '2019-10-29 13:00:17', 'dict:add', 2);
INSERT INTO `t_menu`
VALUES (65, b'0', '字典编辑', '', 39, 3, '', '', b'0', b'0', '', '2019-10-29 13:00:42', 'dict:edit', 2);
INSERT INTO `t_menu`
VALUES (66, b'0', '字典删除', '', 39, 4, '', '', b'0', b'0', '', '2019-10-29 13:00:59', 'dict:del', 2);
INSERT INTO t_menu
VALUES (70, b'0', '图片上传', '', 16, 2, '', '', b'0', b'0', '', '2019-10-29 13:05:34', 'pictures:add', 2);
INSERT INTO t_menu
VALUES (71, b'0', '图片删除', '', 16, 3, '', '', b'0', b'0', '', '2019-10-29 13:05:52', 'pictures:del', 2);
INSERT INTO t_menu
VALUES (73, b'0', '任务新增', '', 28, 2, '', '', b'0', b'0', '', '2019-10-29 13:07:28', 'timing:add', 2);
INSERT INTO t_menu
VALUES (74, b'0', '任务编辑', '', 28, 3, '', '', b'0', b'0', '', '2019-10-29 13:07:41', 'timing:edit', 2);
INSERT INTO t_menu
VALUES (75, b'0', '任务删除', '', 28, 4, '', '', b'0', b'0', '', '2019-10-29 13:07:54', 'timing:del', 2);
INSERT INTO t_menu
VALUES (77, b'0', '上传文件', '', 18, 2, '', '', b'0', b'0', '', '2019-10-29 13:09:09', 'storage:add', 2);
INSERT INTO t_menu
VALUES (78, b'0', '文件编辑', '', 18, 3, '', '', b'0', b'0', '', '2019-10-29 13:09:22', 'storage:edit', 2);
INSERT INTO t_menu
VALUES (79, b'0', '文件删除', '', 18, 4, '', '', b'0', b'0', '', '2019-10-29 13:09:34', 'storage:del', 2);
INSERT INTO t_menu
VALUES (80, b'0', '服务监控', 'monitor/server/index', 6, 14, 'codeConsole', 'server', b'0', b'0', 'ServerMonitor',
        '2019-11-07 13:06:39', 'server:list', 1);
INSERT INTO t_menu
VALUES (82, b'0', '生成配置', 'generator/config', 36, 33, 'dev', 'generator/config/:tableName', b'1', b'1',
        'GeneratorConfig', '2019-11-17 20:08:56', '', 1);
INSERT INTO t_menu
VALUES (83, b'0', '图表库', 'components/Echarts', 10, 50, 'chart', 'echarts', b'1', b'0', 'Echarts', '2019-11-21 09:04:32',
        '', 1);
INSERT INTO t_menu
VALUES (90, b'0', '运维管理', '', 0, 20, 'mnt', 'mnt', b'0', b'0', 'Mnt', '2019-11-09 10:31:08', NULL, 1);
INSERT INTO t_menu
VALUES (92, b'0', '服务器', 'mnt/server/index', 90, 22, 'server', 'mnt/serverDeploy', b'0', b'0', 'ServerDeploy',
        '2019-11-10 10:29:25', 'serverDeploy:list', 1);
INSERT INTO t_menu
VALUES (93, b'0', '应用管理', 'mnt/app/index', 90, 23, 'app', 'mnt/app', b'0', b'0', 'App', '2019-11-10 11:05:16',
        'app:list', 1);
INSERT INTO t_menu
VALUES (94, b'0', '部署管理', 'mnt/deploy/index', 90, 24, 'deploy', 'mnt/deploy', b'0', b'0', 'Deploy',
        '2019-11-10 15:56:55', 'deploy:list', 1);
INSERT INTO t_menu
VALUES (97, b'0', '部署备份', 'mnt/deployHistory/index', 90, 25, 'backup', 'mnt/deployHistory', b'0', b'0', 'DeployHistory',
        '2019-11-10 16:49:44', 'deployHistory:list', 1);
INSERT INTO t_menu
VALUES (98, b'0', '数据库管理', 'mnt/database/index', 90, 26, 'database', 'mnt/database', b'0', b'0', 'Database',
        '2019-11-10 20:40:04', 'database:list', 1);
INSERT INTO t_menu
VALUES (102, b'0', '删除', '', 97, 999, '', '', b'0', b'0', '', '2019-11-17 09:32:48', 'deployHistory:del', 2);
INSERT INTO t_menu
VALUES (103, b'0', '服务器新增', '', 92, 999, '', '', b'0', b'0', '', '2019-11-17 11:08:33', 'serverDeploy:add', 2);
INSERT INTO t_menu
VALUES (104, b'0', '服务器编辑', '', 92, 999, '', '', b'0', b'0', '', '2019-11-17 11:08:57', 'serverDeploy:edit', 2);
INSERT INTO t_menu
VALUES (105, b'0', '服务器删除', '', 92, 999, '', '', b'0', b'0', '', '2019-11-17 11:09:15', 'serverDeploy:del', 2);
INSERT INTO t_menu
VALUES (106, b'0', '应用新增', '', 93, 999, '', '', b'0', b'0', '', '2019-11-17 11:10:03', 'app:add', 2);
INSERT INTO t_menu
VALUES (107, b'0', '应用编辑', '', 93, 999, '', '', b'0', b'0', '', '2019-11-17 11:10:28', 'app:edit', 2);
INSERT INTO t_menu
VALUES (108, b'0', '应用删除', '', 93, 999, '', '', b'0', b'0', '', '2019-11-17 11:10:55', 'app:del', 2);
INSERT INTO t_menu
VALUES (109, b'0', '部署新增', '', 94, 999, '', '', b'0', b'0', '', '2019-11-17 11:11:22', 'deploy:add', 2);
INSERT INTO t_menu
VALUES (110, b'0', '部署编辑', '', 94, 999, '', '', b'0', b'0', '', '2019-11-17 11:11:41', 'deploy:edit', 2);
INSERT INTO t_menu
VALUES (111, b'0', '部署删除', '', 94, 999, '', '', b'0', b'0', '', '2019-11-17 11:12:01', 'deploy:del', 2);
INSERT INTO t_menu
VALUES (112, b'0', '数据库新增', '', 98, 999, '', '', b'0', b'0', '', '2019-11-17 11:12:43', 'database:add', 2);
INSERT INTO t_menu
VALUES (113, b'0', '数据库编辑', '', 98, 999, '', '', b'0', b'0', '', '2019-11-17 11:12:58', 'database:edit', 2);
INSERT INTO t_menu
VALUES (114, b'0', '数据库删除', '', 98, 999, '', '', b'0', b'0', '', '2019-11-17 11:13:14', 'database:del', 2);
INSERT INTO t_menu
VALUES (116, b'0', '生成预览', 'generator/preview', 36, 999, 'java', 'generator/preview/:tableName', b'1', b'1', 'Preview',
        '2019-11-26 14:54:36', NULL, 1);

-- ----------------------------
-- Table structure for t_mnt_app
-- ----------------------------
DROP TABLE IF EXISTS `t_mnt_app`;
CREATE TABLE `t_mnt_app`
(
...
-- ----------------------------
-- Records of t_mnt_app
-- ----------------------------
INSERT INTO `t_mnt_app`
VALUES (1, 'eladmin-monitor-2.4.jar', '/opt/upload', '/opt/monitor', '/opt/backup', 8777,
        'cd /opt/monitor\nnohup java -jar eladmin-monitor-2.4.jar >nohup.out 2>&1 &',
        'mv -f /opt/upload/eladmin-monitor-2.4.jar /opt/monitor\ncd /opt/monitor\nnohup java -jar eladmin-monitor-2.4.jar >nohup.out 2>&1 &',
        '2019-11-24 20:52:59');
INSERT INTO `t_mnt_app`
VALUES (2, 'eladmin-system-2.3.jar', '/opt/upload', '/opt/eladmin', '/opt/backup/eladmin', 8000,
        'cd /opt/eladmin\nnohup java -jar eladmin-system-2.3.jar --spring.profiles.active=prod >nohup.out 2>&1 &',
        'mv -f /opt/upload/eladmin-system-2.3.jar /opt/eladmin/\ncd /opt/eladmin\nnohup java -jar eladmin-system-2.3.jar --spring.profiles.active=prod >nohup.out 2>&1 &',
        '2019-12-21 16:39:57');

-- ----------------------------
-- Table structure for t_mnt_database
-- ----------------------------
DROP TABLE IF EXISTS `t_mnt_database`;
CREATE TABLE `t_mnt_database`
(
...
-- ----------------------------
-- Records of t_mnt_database
-- ----------------------------
INSERT INTO `t_mnt_database`
VALUES ('c4109eefc5724c65857ca9dd2690e0dd', 'eladmin',
        'jdbc:mysql://localhost:3306/eladmin?serverTimezone=Asia/Shanghai', 'root', '123456', '2019-12-21 21:11:17');

-- ----------------------------
-- Table structure for t_mnt_deploy
-- ----------------------------
DROP TABLE IF EXISTS `t_mnt_deploy`;
CREATE TABLE `t_mnt_deploy`
(
    ...
    CONSTRAINT `FK6sy157pseoxx4fmcqr1vnvvhy` FOREIGN KEY (`app_id`) REFERENCES `t_mnt_app` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  AUTO_INCREMENT = 7
  CHARACTER SET = utf8
...
-- ----------------------------
-- Records of t_mnt_deploy
-- ----------------------------
INSERT INTO `t_mnt_deploy`
VALUES (3, 1, '2019-12-21 15:53:06');
INSERT INTO `t_mnt_deploy`
VALUES (6, 2, '2019-12-21 17:09:02');

-- ----------------------------
-- Table structure for t_mnt_deploy_history
-- ----------------------------
DROP TABLE IF EXISTS `t_mnt_deploy_history`;
CREATE TABLE `t_mnt_deploy_history`
(
...
-- ----------------------------
-- Records of t_mnt_deploy_history
-- ----------------------------
INSERT INTO `t_mnt_deploy_history`
VALUES ('4ee0edd1f3b648a396280a542d72c121', 'eladmin-monitor-2.4.jar', '2019-12-22 13:06:07', 'admin', '132.232.129.20',
        3);
INSERT INTO `t_mnt_deploy_history`
VALUES ('4fd432a128c947ccae55316b3d5dcd7b', 'eladmin-monitor-2.4.jar', '2019-12-22 13:49:09', 'admin', '132.232.129.20',
        3);
INSERT INTO `t_mnt_deploy_history`
VALUES ('cfda21f48da341b396657af94554c890', 'eladmin-monitor-2.4.jar', '2019-12-22 13:08:22', 'admin', '132.232.129.20',
        3);

-- ----------------------------
-- Table structure for t_mnt_deploy_server
-- ----------------------------
DROP TABLE IF EXISTS `t_mnt_deploy_server`;
CREATE TABLE `t_mnt_deploy_server`
(
    `deploy_id` bigint(20) NOT NULL,
    `server_id` bigint(20) NOT NULL,
    PRIMARY KEY (`deploy_id`, `server_id`) USING BTREE,
    INDEX `FKeaaha7jew9a02b3bk9ghols53` (`server_id`) USING BTREE,
    CONSTRAINT `FK3cehr56tedph6nk3gxsmeq0pb` FOREIGN KEY (`deploy_id`) REFERENCES t_mnt_deploy (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT `FKeaaha7jew9a02b3bk9ghols53` FOREIGN KEY (`server_id`) REFERENCES `t_mnt_server` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8
...
-- ----------------------------
-- Records of t_mnt_deploy_server
-- ----------------------------
INSERT INTO `t_mnt_deploy_server`
VALUES (3, 1);
INSERT INTO `t_mnt_deploy_server`
VALUES (6, 1);

-- ----------------------------
-- Table structure for t_mnt_server
-- ----------------------------
DROP TABLE IF EXISTS `t_mnt_server`;
CREATE TABLE `t_mnt_server`
(
...
-- ----------------------------
-- Records of t_mnt_server
-- ----------------------------
INSERT INTO `t_mnt_server`
VALUES (1, 'root', '132.232.129.20', '腾讯云', 'Dqjdda1996.', 8013, '2019-11-24 20:35:02');

-- ----------------------------
-- Table structure for t_monitor_server
-- ----------------------------
DROP TABLE IF EXISTS `t_monitor_server`;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '服务监控'
  ROW_FORMAT = Compact;

-- ----------------------------
-- Records of t_monitor_server
-- ----------------------------
INSERT INTO `t_monitor_server`
VALUES (1, 8, 0.05924018, 465.12402, 91.66521, 7.849415, 7.6052284, '本地', 8777, 999, '0', 14.599415, 11.263367,
        'localhost');
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = 'Sm.Ms图床'
  ROW_FORMAT = Compact;
...
VALUES (1, 'visitsTask', '0 0 0 * * ?', b'0', '更新访客记录', 'run', NULL, '每日0点创建新的访客记录', '2019-01-08 14:53:31');
INSERT INTO `t_quartz_job`
VALUES (2, 'testTask', '0/5 * * * * ?', b'1', '测试1', 'run1', 'test', '带参测试，多参使用json', '2019-08-22 14:08:29');
INSERT INTO `t_quartz_job`
VALUES (3, 'testTask', '0/5 * * * * ?', b'1', '测试', 'run', '', '不带参测试', '2019-09-26 16:44:39');
...
-- ----------------------------
INSERT INTO `t_role`
VALUES (1, '超级管理员', '-', '全部', 1, '2018-11-23 11:04:37', 'admin');
INSERT INTO `t_role`
VALUES (2, '普通用户', '-', '本级', 2, '2018-11-23 13:09:06', 'common');

-- ----------------------------
-- Table structure for t_roles_depts
-- ----------------------------
DROP TABLE IF EXISTS `t_roles_depts`;
CREATE TABLE `t_roles_depts`
(
    `role_id` bigint(20) NOT NULL,
    `dept_id` bigint(20) NOT NULL,
    PRIMARY KEY (`role_id`, `dept_id`) USING BTREE,
    INDEX `FK7qg6itn5ajdoa9h9o78v9ksur` (`dept_id`) USING BTREE,
    CONSTRAINT `FK7qg6itn5ajdoa9h9o78v9ksur` FOREIGN KEY (`dept_id`) REFERENCES t_dept (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT `FKrg1ci4cxxfbja0sb0pddju7k` FOREIGN KEY (`role_id`) REFERENCES t_role (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8
...
(
    ...
    CONSTRAINT `FKo7wsmlrrxb2osfaoavp46rv2r` FOREIGN KEY (`menu_id`) REFERENCES t_menu (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT `FKtag324maketmxffly3pdyh193` FOREIGN KEY (`role_id`) REFERENCES t_role (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8
...
(
    ...
    `user_type`                tinyint(1)                                              NULL DEFAULT 0 COMMENT '用户类型 0-普通用户，1-管理员，2-会员',
    `member_start_time`        datetime                                                NULL DEFAULT NULL COMMENT '会员开通时间',
    `member_end_time`          datetime                                                NULL DEFAULT NULL COMMENT '会员结束时间',
    `create_time`              datetime                                                NULL DEFAULT NULL COMMENT '创建日期',
    ...
    CONSTRAINT `FKpq2dhypk2qgt68nauh2by22jb` FOREIGN KEY (`avatar_id`) REFERENCES `t_user_avatar` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  AUTO_INCREMENT = 4
  CHARACTER SET = utf8
...
-- ----------------------------
INSERT INTO `t_user`
VALUES (1, NULL, 'zhengjie@tom.com', 1, '$2a$10$fP.426qKaTmix50Oln8L.uav55gELhAd0Eg66Av4oG86u8km7D/Ky', 'admin',
        '18888888888', '2018-08-23 09:11:56', '2019-05-18 17:34:21', '管理员', '男');
INSERT INTO `t_user`
VALUES (3, NULL, 'test@eladmin.net', 1, '$2a$10$HhxyGZy.ulf3RvAwaHUGb.k.2i9PBpv4YbLMJWp8pES7pPhTyRCF.', 'test',
        '17777777777', '2018-12-27 20:05:26', '2019-04-01 09:15:24', '测试', '男');

-- ----------------------------
-- Table structure for t_user_avatar
-- ----------------------------
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '系统用户头像'
  ROW_FORMAT = Compact;
...
(
    ...
    CONSTRAINT `FKgd3iendaoyh04b95ykqise6qh` FOREIGN KEY (`user_id`) REFERENCES t_user (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT `FKt4v0rrweyk393bdgt107vdx0x` FOREIGN KEY (`role_id`) REFERENCES t_role (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB
  CHARACTER SET = utf8
...
(
  ...
  AUTO_INCREMENT = 3
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '验证码'
  ROW_FORMAT = Compact;
...
(
  ...
  AUTO_INCREMENT = 21
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '访客记录'
  ROW_FORMAT = Compact;
...
(
    ...
    `model`       varchar(10)        NOT NULL comment '机型',
    `mobile`      varchar(15)        NULL comment '手机号',
    `email`       varchar(30)        NULL comment '邮箱',
    `create_time` timestamp          null default current_timestamp comment '创建时间',
    `update_time` timestamp          null default current_timestamp on update current_timestamp comment '更新时间'
) default character set 'utf8mb4' comment '用户反馈';

DROP TABLE IF EXISTS `t_app_version`;
CREATE TABLE `t_app_version`
(
    `id`           bigint primary key not null auto_increment,
    `title`        varchar(50)        not null comment '更新标题',
    `content`      varchar(200)       not null comment '更新内容',
    `version_code` int comment '版本号',
    `version_name` varchar(10) comment '版本名称',
    `download_url` varchar(255) comment '下载地址',
    `enable`       int(2)                  default 0 comment '启用状态 0-禁用，1-启用',
    `force_update` int(2)                  default 0 comment '是否强制更新 0-普通更新 ，1-强制更新',
    `create_time`  timestamp          null default current_timestamp comment '创建时间',
    `update_time`  timestamp          null default current_timestamp on update current_timestamp comment '更新时间'
) default character set 'utf8mb4' comment 'app版本';

DROP TABLE IF EXISTS `t_banner`;
CREATE TABLE `t_banner`
(
    `id`          bigint primary key not null auto_increment,
    `title`       varchar(50)        null comment '轮播图标题',
    `banner_url`  varchar(255)       not null comment '图片地址',
    `type`        int(2)             not null comment 'banner类型 0-电影，1-tv，2-动漫，3-广告',
    `enable`      int(2)                  default 0 comment '启用状态 0-启用，1-禁用',
    `create_time` timestamp          null default current_timestamp comment '创建时间',
    `update_time` timestamp          null default current_timestamp on update current_timestamp comment '更新时间'

) default character set 'utf8mb4' comment '轮播图';
...
(
    ...
    `type`        tinyint(1)              default 0 comment '协议类型 0-用户协议，1-隐私政策',
    `create_time` timestamp          null default current_timestamp comment '创建时间',
    `update_time` timestamp          null default current_timestamp on update current_timestamp comment '更新时间'
) default character set 'utf8mb4' comment '协议'